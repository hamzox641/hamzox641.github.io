...
import 'package:glaz/controllers/dessert_controller.dart';
...
class DessertPage extends StatefulWidget {
  const DessertPage({Key? key, required this.dessert}) : super(key: key);
  final DessertModel dessert;

  @override
  State<DessertPage> createState() => _FoodPageState();
}

class _FoodPageState extends State<DessertPage> {
  ...
  Widget build(BuildContext context) {
    ...
    LoginRespnse? user;
    final controller = Get.put(DessertController());
    final loginController = Get.put(LoginController());
    user = loginController.getUserInfo();

    controller.loadAdditives(widget.dessert.additives);
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      itemCount: widget.dessert.imageUrl.length,
                      itemBuilder: (context, i) {
                        return Container(
                          ...
                          child: CachedNetworkImage(
                            fit: BoxFit.cover,
                            imageUrl: widget.dessert.imageUrl[i],
                          ),
                        );
                      },
                    ),
                    ...
                    child: Obx(
                      () => Row(
                        ...
                        children: List.generate(
                          widget.dessert.imageUrl.length,
                          (index) {
                            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ReusableText(
                        text: widget.dessert.title,
                        style: appStyle(18, kDark, FontWeight.w600),
                      ),
                      Obx(
                        () => ReusableText(
                          text:
                              "\DH ${((widget.dessert.price + controller.additivePrice) * controller.count.value)}",
                  ...
                  SizedBox(
                    ...
                    child: ListView(
                        ...
                        children: List.generate(widget.dessert.foodTags.length,
                            (index) {
                          final tag = widget.dessert.foodTags[index];
                      ...
                      children: List.generate(controller.additivesList.length,
                        ...
                        return CheckboxListTile(
                            ...
                            onChanged: (bool? value) {
                              ...
                              controller.getList();
                              //print(controller.getCarAdditive());
                            });
                      }),
                    ),
                  ),
                        ...
                        GestureDetector(
                          onTap: () async {
                            if (user == null) {
                              ...
                              double price = (widget.dessert.price +
