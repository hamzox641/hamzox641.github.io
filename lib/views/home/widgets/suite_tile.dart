...
import 'package:glaz/views/home/rating/rating_food_page.dart';

class SuiteTile extends StatelessWidget {
  const SuiteTile({super.key, required this.food, this.color});
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ReusableText(
                        text: "Temps de préparation : ${food.time}",
            ...
            child: Column(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.to(
                      () => RatingFoodPage(productId: food.id),
