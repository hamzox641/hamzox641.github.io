...
List<CommencerModel> commencerModelFromJson(String str) =>
    List<CommencerModel>.from(
        json.decode(str).map((x) => CommencerModel.fromJson(x)));

String dessertModelToJson(List<CommencerModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CommencerModel {
  final String id;
  final String title;
  final String time;
  ...
  factory CommencerModel.fromJson(Map<String, dynamic> json) => CommencerModel(
        id: json["_id"],
        title: json["title"],
        time: json["time"],
